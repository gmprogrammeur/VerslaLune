...
<body>
	...
	<!-- About Section -->
	<div class="w3-row w3-center w3-green w3-greyscale-min w3-padding-16 w3-text-black">
	...
	<div class="w3-content w3-container w3-padding-64" id="cryptomonnaie">
		...
		<p class="w3-large w3-padding-large">An article on cryptocurrencies, for example<br><a href="https://www.lesnumeriques.com/vie-du-net/qu-est-qu-cryptomonnaie-a3357.html" target="_blank">lesnumeriques.com</a></p>
		...
		<div class="w3-row w3-padding-50">
			...
			<div class="w3-col m6 w3-padding-large">
				...
				<p class="w3-large">Satoshi Nakamoto (聡 中 本 where 中 本) is the pseudonym of the person or group of people who, from 2009 to 2010, designed and created Bitcoin, and the Bitcoin-Qt software (now Bitcoin Core). He is also the founder of <a href="https://bitcoin.org/fr/" target="_blank">bitcoin.org</a> and forum <a href="https://bitcointalk.org/" target="_blank">bitcointalk</a>.<br><a href="https://bitcoin.fr/satoshi-nakamoto/" target="_blank">bitcoin.fr</a></p>
		...
		<p class="w3-large w3-padding-large">An online wallet site (Bitcoin, Ethereum, Litecoin), for example<br><a href="https://www.coinbase.com/" target="_blank">coinbase.com</a> / our affiliate link <a href="https://www.coinbase.com/join/59fb8ab3dd8ddd011c95ccee" target="_blank">coinbase.com</a></p>
		...
		<p class="w3-large w3-padding-large">An article on cryptocurrency portfolios, for example<br><a href="https://www.crypto-france.com/acheter-crypto-monnaies-meilleurs-sites/" target="_blank">crypto-france.com</a></p>
		...
		<p class="w3-large w3-padding-large">A useful site for traders, for example<br><a href="https://bitpay.com/" target="_blank">bitpay.com</a></p>
		...
		<p class="w3-center w3-large">To deepen the subject, some tracks:<br>blockchain, nodes, private keys,<br>proofs, smart contracts, faucets</p>
	...
	<!-- Article -->
	<div class="w3-center w3-yellow w3-greyscale-min w3-padding-16">
	...
	<!-- Article -->
	<div class="w3-center w3-red w3-greyscale-min w3-padding-16 w3-text-black">
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<div class="w3-row">
			...
			<div class="w3-col m6 w3-padding-large">
				...
				<p class="w3-large">A trader is a person who works in the financial markets.<br>His goal is to buy a financial asset and resell it more expensive, to generate a surplus value.<br><a href="http://www.journaldunet.com/business/dictionnaire-economique-et-financier/1199075-trader-definition-traduction-et-synonymes/" target="_blank">journaldunet.com</a></p>
		...
		<div class="w3-row">
			...
			<div class="w3-col m4 w3-padding-large w3-hide-small" style="margin-top: 10px;">
				...
				<img src="Images/biexlo.jpg" class="w3-image w3-opacity-min w3-hover-opacity-off" alt="bittrex logo" width="250" height="250">
		...
		<p class="w3-large w3-padding-large">A site offering a place of exchange (more than 100 cryptoscurrencies), for example<br><a href="https://bittrex.com/" target="_blank">bittrex.com</a></p>
		...
		<p class="w3-large w3-padding-large">An article on cryptocurrency exchanges, for example<br><a href="https://www.crypto-france.com/acheter-crypto-monnaies-meilleurs-sites/" target="_blank">crypto-france.com</a></p>
		...
		<p class="w3-center w3-large">To deepen the subject, some tracks:<br>short, medium and long-term trading,<br>forks, foreign exchange arbitrage</p>
	...
	<div class="w3-center w3-red w3-greyscale-min w3-padding-16 w3-text-black">
		...
		<p class="w3-center w3-large"><em>We do not recommend leverage, casinos, ponzis !</em></p>
	...
	<div class="bgimg-2 w3-display-container" id="minage">
	  ...
	  <div class="w3-display-middle" style="white-space:nowrap;">
		...
		<h1 class="w3-center w3-padding-large w3-orange w3-greyscale-min w3-text-black w3-xlarge w3-wide"><i class="fa fa-plug w3-hover-text-grey"></i> Blasting</h1>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<p class="w3-large w3-padding-large">An online wallet site (more than 10 cryptocurrencies), for example<br><a href="https://fr.cryptonator.com/" target="_blank">cryptonator.com</a>  / our affiliate link <a href="https://fr.cryptonator.com/auth/signup/101577394" target="_blank">cryptonator.com</a></p>
		...
		<p class="w3-large w3-padding-large">A site offering mining contracts, for example<br><a href="https://www.just-mining.com/" target="_blank">just-mining.com</a> / our affiliate link <a href="https://www.just-mining.com/register/XRhEzBxd4f18GHYrxz5AawdPz" target="_blank">just-mining.com</a></p>
		...
		<p class="w3-large w3-padding-large">A site offering mining equipment, for example<br><a href="https://www.just-mining.com/" target="_blank">just-mining.com</a> / our affiliate link <a href="https://www.just-mining.com/register/XRhEzBxd4f18GHYrxz5AawdPz" target="_blank">just-mining.com</a></p>
		...
		<p class="w3-large w3-padding-large">An article on mining, for example<br><a href="https://www.canardcoincoin.com/miner-crypto-monnaie/" target="_blank">canardcoincoin.com</a></p>

		<p class="w3-center w3-large">To deepen the subject, some tracks:<br>hashing, pools, ASICs</p>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <h3 class="w3-center w3-large"><em>How can I find out about cryptocurrencies ?</em></h3>
		...
		<p class="w3-large w3-padding-large">A player in the world of cryptocurrencies on social networks, for example<br>Twitter <a href="https://twitter.com/PowerHasheur" target="_blank">PowerHasheur</a></p>
	...
	<div class="bgimg-2 w3-display-container" id="graphique">
	  ...
	  <div class="w3-display-middle" style="white-space:nowrap;">
		...
		<h1 class="w3-center w3-padding-large w3-orange w3-greyscale-min w3-text-black w3-xlarge w3-wide"><i class="fa fa-line-chart w3-hover-text-grey"></i> Graphic</h1>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <h3 class="w3-center w3-large"><em>What are the graphics ?</em></h3>
		...
		<p class="w3-large w3-padding-large">A simple and professional graphic site, for example<br><a href="https://www.coinigy.com/" target="_blank">coinigy.com</a> (a free trial period by registration)</p>
		...
		<p class="w3-center w3-large">-<a href="https://www.tradingview.com/u/DianKemala/" target="_blank">DianKemala</a><br>-<a href="https://www.tradingview.com/u/goldbug1/" target="_blank">goldbug1</a><br>-<a href="https://www.tradingview.com/u/WinnyCrypto/" target="_blank">WinnyCrypto</a><br>-<a href="https://www.tradingview.com/u/bethek/" target="_blank">bethek</a></p>
	...
	<div class="w3-row w3-center w3-orange w3-greyscale-min w3-padding-16 w3-text-black">
		...
		<div class="w3-quarter w3-large">
			...
			<p><i class="fa fa-balance-scale w3-hover-text-grey"></i><br>Buy/Sell</p>
	  ...
	  <h3 class="w3-center w3-large"><em>What is an ICO ?</em></h3>
		...
		<div class="w3-row">
			...
			<div class="w3-col m6 w3-padding-large">
				...
				<p class="w3-large">ICO (Initial Coin Offering) is a method of fundraising by issuing cryptocurrency tokens. During an ICO, a company typically sells some of its cryptocurrency tokens in exchange for money. The funding is used to distribute tokens to the market and fund the expenses of the founding team.<br><a href="https://www.coingecko.com/ico?locale=en" target="_blank">coingecko.com</a></p>
		...
		<p class="w3-large w3-padding-large">An article on ICO, for example<br><a href="https://www.crypto-france.com/ico-liste-initial-coin-offering-levees-de-fonds-crypto-monnaies/" target="_blank">crypto-france.com</a></p>
	...
	<div class="bgimg-2 w3-display-container" id="apropos">
	  ...
	  <div class="w3-display-middle" style="white-space:nowrap;">
		...
		<h1 class="w3-center w3-padding-large w3-orange w3-greyscale-min w3-text-black w3-xlarge w3-wide"><i class="fa fa-question w3-hover-text-grey"></i> About me</h1>
	...
	<!-- Don -->
	<div class="w3-center w3-orange w3-greyscale-min w3-padding-16 w3-text-black">

		<h3 class="w3-center"><i class="fa fa-bitcoin w3-hover-text-grey"></i> DON</h3>

		<p class="w3-center w3-large">Give us the strength to continue<br>Without ads, without products for sale</p>

		<p class="w3-center w3-large">ETHEREUM<br>0x218a61ab4db96e769f6f9800c31cfdb8cd900f16<br>LITECOIN<br>LKcjs1XGxS7Np5ajoY1ixySn2wppoBJ5ua<br>ZCASH<br>t1UF95rxJyTWLa5ivsQ3m3GfBAoPS3BsoFx</p>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<p class="w3-center w3-large">Send us a message by email</p>
	...
	<!-- Collaboration -->
	<div class="w3-row w3-center w3-blue w3-greyscale-min w3-text-black w3-padding-16">
	...
	<footer class="w3-center w3-orange w3-greyscale-min w3-padding-64">
	  ...
	  <p class="w3-center w3-large" style="margin-bottom: 0;"><i class="fa fa-laptop w3-hover-text-grey"></i> <i class="fa fa-tablet w3-hover-text-grey"></i> <i class="fa fa-mobile w3-hover-text-grey"></i><br><i class="fa fa-rocket w3-hover-text-grey"></i> Vers la Lune <i class="fa fa-copyright w3-hover-text-grey"></i> 2017</p>
