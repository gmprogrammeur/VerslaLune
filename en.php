...
<body>
	...
	<div class="w3-row w3-center w3-green w3-padding-16 w3-text-black" id="cryptomonnaie">
		...
		<div class="w3-quarter w3-large">
			...
			<p><i class="fa fa-info w3-hover-text-grey"></i><br><a href="https://journalducoin.com/videos/hasheur-ethereum-evolutions-risques-investissements/" target="_blank">journalducoin.com</a></p>
		...
		<div class="w3-quarter w3-large">
			...
			<p><i class="fa fa-bomb w3-hover-text-grey"></i><br><a href="https://rentberry.cryptonomos.com/" target="_blank">rentberry.cryptonomos.com</a></p>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<div class="w3-row w3-padding-50">
			...
			<div class="w3-col m6 w3-padding-large">
				...
				<p class="w3-center w3-large">-<a href="https://bitcoin.org/fr/" target="_blank">Bitcoin</a><br>-<a href="https://litecoin.org/fr/" target="_blank">Litecoin</a><br>-<a href="https://www.ethereum.org/" target="_blank">Ethereum</a><br>-<a href="https://z.cash/" target="_blank">Zcash</a></p>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<p class="w3-large w3-padding-large">Un site proposant une place d'échange (plus de 100 cryptos-monnaies), par exemple<br><a href="https://www.binance.com/?ref=20271122" target="_blank">binance.com</a></p>
		...
		<div class="w3-row-padding w3-center w3-section w3-large">
	    	...
	    	<div class="w3-col m4">
	    		...
	    		<p><b>Social networks</b></p>
	      		...
	      		<a href="https://twitter.com/LangueDeGeek" target="_blank">LangueDeGeek</a><br>
	      		...
	      		<a href="https://twitter.com/InvestirCrypto" target="_blank">InvestirCrypto</a><br>
	      		<a href="https://twitter.com/CryptoTempsReel" target="_blank">CryptoTempsReel</a><br>
	  ...
	  <h3 class="w3-center w3-large"><em>What is an ICO ?</em></h3>
		...
		<div class="w3-row w3-padding-50">
			...
			<div class="w3-col m6 w3-padding-large">
				...
				<p class="w3-center w3-large">-<a href="https://rentberry.cryptonomos.com/" target="_blank">rentberry.cryptonomos.com</a><br>-TON</p>
	...
	<div class="w3-center w3-orange w3-padding-16 w3-text-black">
		...
		<h3 class="w3-center"><i class="fa fa-beer w3-hover-text-grey"></i> A TIP</h3>
