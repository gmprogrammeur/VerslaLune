...
<body>
	...
	<div class="w3-center w3-red w3-padding-16 w3-text-black">
		...
		<p class="w3-center w3-large"><em>We do not advise newcomers leverage, short selling and casinos !</em></p>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <h3 class="w3-center w3-large"><em>How can I find out about cryptocurrencies ?</em></h3>
		...
		<p class="w3-large w3-padding-large">A player in the world of cryptocurrencies on social networks, for example<br><a href="https://twitter.com/PowerHasheur" target="_blank">twitter.com/PowerHasheur</a></p>
		...
		<div class="w3-row-padding w3-center w3-section w3-large">
	    	...
	    	<div class="w3-col m4">
	    		...
	    		<p><b>Social networks</b></p>
	      		...
	      		<a href="https://twitter.com/Crypto_yann" target="_blank">twitter.com/Crypto_yann</a><br>
	      		...
	      		<a href="https://twitter.com/AssoCDC" target="_blank">twitter.com/AssoCDC</a><br>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <h3 class="w3-center w3-large"><em>What are the graphics ?</em></h3>
		...
		<p class="w3-large w3-padding-large">An article about graphics, for example<br><a href="https://cryptoast.fr/analyse-technique-cryptos/" target="_blank">cryptoast.fr</a></p>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <h3 class="w3-center w3-large"><em>What is an ICO ?</em></h3>
		...
		<p class="w3-large w3-padding-large">An online wallet site, for example<br><a href="https://www.myetherwallet.com/" target="_blank">myetherwallet.com</a></p>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <div class="w3-row">
		...
		<div class="w3-col m6 w3-center w3-padding-large">
		  ...
		  <p class="w3-center w3-large"><b>Anonymous</b><br>Unknown</p>
