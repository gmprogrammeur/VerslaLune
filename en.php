...
<body>
	...
	<div class="w3-row w3-center w3-green w3-padding-16 w3-text-black" id="cryptomonnaie">
		...
		<div class="w3-quarter w3-large">
			...
			<p><i class="fa fa-line-chart w3-hover-text-grey"></i><br><a href="https://www.tradingview.com/chart/ETHUSD/64JysATv-Ethereum/" target="_blank">tradingview.com</a></p>

		</div>

		<div class="w3-quarter w3-large">

			<p><i class="fa fa-bomb w3-hover-text-grey"></i><br><a href="https://kryll.io/fr/" target="_blank">kryll.io</a></p>
	  ...
	  <h3 class="w3-center w3-large"><em>What is an ICO ?</em></h3>
		...
		<div class="w3-row w3-padding-50">
			...
			<div class="w3-col m6 w3-padding-large">
				...
				<p class="w3-center w3-large">-<a href="https://kryll.io/fr/" target="_blank">kryll.io</a></p>
