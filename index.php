...
<body>
	...
	<div class="w3-center w3-red w3-padding-16 w3-text-black">
		...
		<p class="w3-center w3-large"><em>Nous déconseillons aux nouveaux venus l'effet de levier, la vente à découvert et les casinos !</em></p>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <h3 class="w3-center w3-large"><em>C'est quoi un ICO ?</em></h3>
		...
		<p class="w3-large w3-padding-large">Un site de portefeuille en ligne, par exemple<br><a href="https://www.myetherwallet.com/" target="_blank">myetherwallet.com</a></p>
