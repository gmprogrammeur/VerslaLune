...
<body>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<p class="w3-large w3-padding-large">Un site proposant un casino de crypto-monnaies, par exemple<br><a href="https://www.bitsler.com/" target="_blank">bitsler.com</a></p>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<p class="w3-center w3-large">Pour approfondir le sujet, quelques pistes:<br>le trading à court, moyen, long terme,<br>les forks, l'arbitrage de change, l'effet de levier,<br>la vente à découvert, l'analyse fondamental</p>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <div class="w3-row">
		...
		<div class="w3-col m6 w3-center w3-padding-large">
		  ...
		  <p class="w3-center w3-large"><b>Geoffrey M</b><br>Tradeur</p>
