...
<body>
	...
	<div class="w3-content w3-container w3-padding-64" id="cryptomonnaie">
		...
		<p class="w3-large w3-padding-large">Un site de portefeuille en ligne (Bitcoin, Ethereum, Litecoin), par exemple<br><a href="https://www.coinbase.com/" target="_blank">coinbase.com</a> / notre lien d'affiliation <a href="https://www.coinbase.com/join/59fb8ab3dd8ddd011c95ccee" target="_blank">coinbase.com</a></p>
		...
		<p class="w3-center w3-large">Pour approfondir le sujet, quelques pistes:<br>la blockchain, les noeuds, les clefs privées,<br>les preuves, Les contrats intelligents, les robinets</p>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<p class="w3-large w3-padding-large">Un site proposant une place d'échange (plus de 100 cryptos-monnaies), par exemple<br><a href="https://bittrex.com/" target="_blank">bittrex.com</a></p>
	...
	<div class="w3-center w3-red w3-greyscale-min w3-padding-16 w3-text-black">
		...
		<p class="w3-center w3-large"><em>Nous déconseillons l'effet de levier, les casinos, les ponzis !</em></p>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<p class="w3-large w3-padding-large">Un site de portefeuille en ligne (plus de 10 crypto-monnaies), par exemple<br><a href="https://fr.cryptonator.com/" target="_blank">cryptonator.com</a>  / notre lien d'affiliation <a href="https://fr.cryptonator.com/auth/signup/101577394" target="_blank">cryptonator.com</a></p>
		...
		<p class="w3-large w3-padding-large">Un site proposant des contrats de minage, par exemple<br><a href="https://www.just-mining.com/" target="_blank">just-mining.com</a> / notre lien d'affiliation <a href="https://www.just-mining.com/register/XRhEzBxd4f18GHYrxz5AawdPz" target="_blank">just-mining.com</a></p>
		...
		<p class="w3-large w3-padding-large">Un site proposant du matériels de minage, par exemple<br><a href="https://www.just-mining.com/" target="_blank">just-mining.com</a> / notre lien d'affiliation <a href="https://www.just-mining.com/register/XRhEzBxd4f18GHYrxz5AawdPz" target="_blank">just-mining.com</a></p>
		...
		<p class="w3-center w3-large">Pour approfondir le sujet, quelques pistes:<br>le hachage, les piscines, les ASIC</p>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <h3 class="w3-center w3-large"><em>Comment m'informer sur les crypto-monnaies ?</em></h3>
		...
		<h3 class="w3-center w3-large"><b>Listes de source d'information<br>mise en avant par Vers la Lune</b></h3>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <h3 class="w3-center w3-large"><em>C'est quoi les graphiques ?</em></h3>
		...
		<p class="w3-large w3-padding-large">Un site de graphique simple et proféssionel, par exemple<br><a href="https://www.coinigy.com/" target="_blank">coinigy.com</a> (une période d'essai gratuit par inscription)</p>
		...
		<h3 class="w3-center w3-large"><b>Liste de compte sur TradingView<br>mise en avant par Vers la Lune</b></h3>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <h3 class="w3-center w3-large"><em>C'est quoi Vers la Lune ?</em></h3>
	  ...
	  <p class="w3-center w3-large">Vers la Lune propose une initiation au monde des cryptos-monnaies, pour plus d'informations, nous vous invitons à approfondir par vous-même chaque point exposé sur notre site.<br>verslalune.fr</p>
	...
	<div class="w3-center w3-orange w3-greyscale-min w3-padding-16 w3-text-black">
		...
		<p class="w3-center w3-large">Donnez nous la force de continuer<br>Sans publicités, sans produits à vendre</p>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<h3 class="w3-center w3-large"><em>Comment contacter Vers la Lune ?</em></h3>

		<p class="w3-center w3-large">Envoyez nous un message par email</p>
	...
	<div class="w3-row w3-center w3-blue w3-greyscale-min w3-text-black w3-padding-16">
		...
		<p class="w3-center w3-large">Partenaires de Vers la Lune</p>
