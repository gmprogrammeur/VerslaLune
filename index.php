...
<body>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<p class="w3-large w3-padding-large">Un site tenant l'agenda des crypto-monnaies, par exemple<br><a href="https://coinmarketcal.com/" target="_blank">coinmarketcal.com</a></p>
		...
		<div class="w3-row w3-padding-50">
			...
			<div class="w3-col m6 w3-padding-large">
				...
				<p class="w3-large">Satoshi Nakamoto est le pseudonyme du fondateur inconnu du bitcoin et de la première blockchain. Il a affirmé être un Japonais né le 5 avril 1975, cependant on ignore s'il s'agit d'une seule personne ou d'un groupe de personnes, et son origine japonaise est remise en cause par la qualité de son anglais et l'absence totale de publications en japonais. Il est également le créateur du forum bitcointalk. Il posséderait un million de bitcoins. En décembre 2017, la valeur du bitcoin étant proche de 20 000 $, sa fortune etait estimée à 19,4 milliards de dollars, soit la 44e mondiale.<br><a href="https://fr.wikipedia.org/wiki/Satoshi_Nakamoto" target="_blank">wikipedia.org</a></p>
		...
		<p class="w3-large w3-padding-large">Un site qui permet de suivre ses transactions de crypto-monnaies, par exemple<br><a href="https://live.blockcypher.com/" target="_blank">live.blockcypher.com</a></p>
		...
		<h3 class="w3-center w3-large"><em>Existe t'il des casinos de crypto-monnaies ?</em></h3>

		<p class="w3-large w3-padding-large">Un site proposant un casino de crypto-monnaies, par exemple<br><a href="https://www.bitsler.com/" target="_blank">bitsler.com</a> / lien d'affiliation <a href="https://www.bitsler.com/?ref=WinnyCrypto" target="_blank">bitsler.com</a></p>

		<p class="w3-center w3-large">Pour approfondir le sujet, quelques pistes:<br>la blockchain, les noeuds, les clefs,<br>les preuves, Les contrats intelligents, les jetons,<br>les robinets</p>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<h3 class="w3-center w3-large"><em>C'est quoi un tradeur ?</em></h3>

		<div class="w3-row">

			<div class="w3-col m6 w3-padding-large">

				<p class="w3-large">Un opérateur de marché ou opérateur financier, plus communément appelé tradeur, est un négociateur de produits financiers. Il intervient sur les marchés organisés ou de gré à gré. Les opérateurs financiers sont souvent rassemblés au front office, dans la salle de marchés d'une banque d'investissement ou d'une société de gestion d'actifs. Certains d'entre eux sont habilités à traiter en dehors de la salle et en dehors des horaires de bureau. Cependant, certains particuliers se font opérateurs indépendants, intervenant sur les marchés depuis chez eux au moyen d'une connexion à Internet.<br><a href="https://fr.wikipedia.org/wiki/Op%C3%A9rateur_de_march%C3%A9" target="_blank">wikipedia.org</a></p>
		...
		<p class="w3-center w3-large">Pour approfondir le sujet, quelques pistes:<br>le trading à court, moyen, long terme,<br>les forks, l'arbitrage de change, l'effet de levier,<br>la vente à découvert</p>
	...
	<div class="w3-content w3-container w3-padding-64">
		...
		<p class="w3-center w3-large">Pour approfondir le sujet, quelques pistes:<br>Rig, GPU, ASIC</p>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <h3 class="w3-center w3-large"><em>Comment m'informer sur les crypto-monnaies ?</em></h3>
		...
		<p class="w3-large w3-padding-large">Un acteur du monde des crypto-monnaies sur les réseaux sociaux, par exemple<br><a href="https://twitter.com/whale_tamer" target="_blank">twitter.com/whale_tamer</a></p>
		...
		<h3 class="w3-center w3-large"><em>Existe t'il des associations sur les crypto-monnaies ?</em></h3>

		<p class="w3-large w3-padding-large">Un site d'une association sur les crypto-monnaies, par exemple<br><a href="https://lecercleducoin.fr/" target="_blank">lecercleducoin.fr</a></p>
	  ...
	  <h3 class="w3-center w3-large"><em>C'est quoi un ICO ?</em></h3>
		...
		<div class="w3-row">
			...
			<div class="w3-col m6 w3-padding-large">
				...
				<p class="w3-large">Une Initial coin offering (ICO) est une méthode de levée de fonds fonctionnant via l’émission d’actifs numériques échangeables contre des crypto-monnaies durant la phase de démarrage d’un projet. Ces actifs, appelés "tokens" (jeton numérique), sont émis et échangés grâce à la technologie blockchain.<br><a href="https://fr.wikipedia.org/wiki/Initial_coin_offering" target="_blank">wikipedia.org</a></p>
		...
		<p class="w3-large w3-padding-large">Un site de portefeuille en ligne (ERC20), par exemple<br><a href="https://www.myetherwallet.com/" target="_blank">myetherwallet.com</a></p>
	...
	<div class="w3-content w3-container w3-padding-64">
	  ...
	  <div class="w3-row">
		...
		<div class="w3-col m6 w3-center w3-padding-large">
		  ...
		  <p class="w3-center w3-large"><b>WinnyCrypto</b> <a href="https://twitter.com/WinnyCrypto" target="_blank"><i class="fa fa-twitter w3-text-blue w3-hover-text-light-grey"></i></a> <a href="https://www.tradingview.com/u/WinnyCrypto/" target="_blank"><i class="fa fa-line-chart w3-text-black w3-hover-text-light-grey"></i></a><br>Tradeur / Mineur</p>
		...
		<div class="w3-col m6 w3-center w3-padding-large">
		  ...
		  <p class="w3-center w3-large"><b>Anonyme</b><br>Inconnu</p>

		  <img src="Images/anim.jpg" class="w3-image w3-opacity-min w3-hover-opacity-off" alt="Photob" style="width: 300px; height: 400px;">
	...
	<div class="w3-center w3-orange w3-padding-16 w3-text-black">
		...
		<p class="w3-center w3-large">Bitcoin<br>13Q8PWRttyS2n1rUTNh6ibQp2i7kcFDr3v<br>Litecoin<br>LKcjs1XGxS7Np5ajoY1ixySn2wppoBJ5ua<br>Ethereum<br>0x218a61ab4db96e769f6f9800c31cfdb8cd900f16<br>Zcash<br>t1UF95rxJyTWLa5ivsQ3m3GfBAoPS3BsoFx</p>
